 ...
 * L'index est stocke dans une base de données relationnelle POstGres.
 * Utilisation: java test/TestIndexer dir config <br>
 *  dir est le repertoire contenant les documents, et config est le fichier de configuration pour la connexion à la base.
 */
